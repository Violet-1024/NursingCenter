...
<template>
  <div>
    ...
    <div style="margin-top: 20px">
      <el-form :inline="true" :model="formInline" class="demo-form-inline">
        <el-form-item label="订单">
          <el-input style="width: 240px" placeholder="请输入订单编号" v-model="params.orderID"></el-input>
        </el-form-item>
        <el-form-item label="用户">
          <el-input style="width: 240px;margin-left: 5px" placeholder="请输入用户ID" v-model="params.id"></el-input>
        </el-form-item>
        <el-form-item label="时间">
          <el-date-picker style="width: 240px;margin-left: 5px" placeholder="请选择时间" v-model="params.orderTime"></el-date-picker>
        </el-form-item>
    ...
    <el-table :data="tableData" stripe>
      ...
      <el-table-column prop="foodid" label="应付金额"></el-table-column>
